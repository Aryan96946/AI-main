...
class CounselingSession(db.Model):
    ...
    # New enhanced fields
    session_type = db.Column(db.String(50), default='academic')  # academic, behavioral, personal, career
    severity = db.Column(db.String(20), default='medium')  # low, medium, high, critical
    outcomes = db.Column(db.Text)  # Session outcomes and findings
    next_steps = db.Column(db.Text)  # Action items for follow-up
